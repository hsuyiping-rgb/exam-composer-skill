...
2. ~~把 Step 4 經驗寫進 SKILL.md~~ → **已於 2026-09-07 完成**。SKILL.md 由 337 行擴為 409 行，新增：Step 3「撰寫前先避開歷屆高頻命題框架」（含五上數學八個高頻框架對照表）、Step 4「判定分級與處理原則」（★▲△－ 四級＋重寫三條硬約束＋第二輪查重）、Step 4「ESA 操作要點」、Step 5「修改既有 .docx 就地編輯法」、「環境需求」章節。四份 SHA-256 均為 `371CD35F44AF471DA64F50E67B7F0D85D4DE79863B1C8EFD0D71E02EB61B55CB`。
3. **未來每個年段／科目任務，把該次查到的高頻命題框架回寫進 SKILL.md 的對照表**（目前只有五上數學的實證資料）。
