...
3. ~~考慮在常用電腦安裝 LibreOffice~~ **已解決**：DESKTOP-31QBU95 有 LibreOffice 26.8.0.3，Step 5 視覺渲染 QA 在這台可做。kfes 與 DESKTOP-HJA3024 若要獨立做 QA 才需補裝（`winget install TheDocumentFoundation.LibreOffice`）。
